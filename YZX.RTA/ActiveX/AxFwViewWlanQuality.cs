...
{
  public class AxFwViewWlanQuality : FlexibleHost
  {
    private IFwViewProperty ocx;
    ...
    public AxFwViewWlanQuality()
      : base("e24b10e8-9849-4685-b8ea-211fae63755e")
    {
    }
    ...
    protected override void AttachInterfaces()
    {
      ...
      try
      {
        this.ocx = (FwViewWlanQuality)this.GetOcx();
      }
      catch (Exception ex)
      {
